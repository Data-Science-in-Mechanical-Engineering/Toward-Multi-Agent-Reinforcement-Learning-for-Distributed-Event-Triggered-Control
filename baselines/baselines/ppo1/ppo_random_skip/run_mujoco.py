...
def train(seed, num_options, app, saves ,wsaves, epoch, dc, num, render ,timesteps_per_batch, comm_weight, explo_iters,\
          deviation, entro_iters, final_entro_iters, begintime, stoptime, pol_ov_op_ent, final_pol_ov_op_ent, optim_epochs, optim_stepsize,\
...
def main():
    ...
    parser.add_argument('--timesteps_per_batch', type=float, default=2048) # parameters for optimization process
    parser.add_argument('--optim_epochs', type=float, default=10)
    parser.add_argument('--optim_stepsize', type=float, default=3e-5)
    parser.add_argument('--optim_batchsize', type=float, default=32)
    ...
    parser.add_argument('--forward_reward', type=float, default=5)
    parser.add_argument('--terminate_reward', type=float, default=-100)
    parser.add_argument('--fall_reward', type=float, default=-10)
    parser.add_argument('--max_cycles', type=float, default=500)
